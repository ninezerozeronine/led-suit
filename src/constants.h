...
namespace constants {
    const byte POT_0_PIN = A0;
    const byte POT_1_PIN = A1;
    const byte POT_2_PIN = A2;
    const byte POT_3_PIN = A3;
    const byte POT_4_PIN = A6;
    const byte BUTTON_0_PIN = 4;
    const byte LED_DATA_PIN = 2;

    const byte MODE_CHANGE_PIN = 3;
